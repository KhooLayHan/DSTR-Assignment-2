...
class Player {
    public:
        ...
        std::vector<std::string> getPreviousMatchIds() const { return m_PreviousMatchIds; }
        ...
        void addPreviousMatchId(const std::string& matchId) { m_PreviousMatchIds.push_back(matchId); }
